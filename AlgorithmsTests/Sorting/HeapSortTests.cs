...
namespace AlgorithmsTests.Sorting
{
	...
	public class HeapSortTests
	{
		...
		public void SortAscending(int[] data)
		{
			...
			_stopWatch.Start();
			HeapSort.SortAscending(ref data, data.Length);
			_stopWatch.Stop();

			Logger.WriteLine($"**********************************************************************");
			Logger.WriteLine($"HeapSort | ascending");
		...
		public void SortDescending(int[] data)
		{
			...
			_stopWatch.Start();
			HeapSort.SortDescending(ref data, data.Length);
			_stopWatch.Stop();

			Logger.WriteLine($"**********************************************************************");
			Logger.WriteLine($"HeapSort | descending");
			Logger.WriteLine($"Input: {JsonSerializer.Serialize(ogData)}");
			Logger.WriteLine($"Output: {JsonSerializer.Serialize(data)}");
			Logger.WriteLine($"Elapsed Time: {_stopWatch.Elapsed.ToString()}");
			Logger.WriteLine($"**********************************************************************");
